...
namespace QuanLyTinTuc.Controllers
{
    public class ChuDesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaChuDe,TenChuDe,TrangThai")] ChuDe chuDe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaChuDe,TenChuDe,TrangThai")] ChuDe chuDe)
        {
            if (ModelState.IsValid)
            {
